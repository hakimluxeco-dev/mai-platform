...
export default function InstallPrompt() {
    ...
    return (
        <div className="fixed bottom-4 left-4 right-4 z-50 animate-in slide-in-from-bottom-10 fade-in duration-500">
            <div className="bg-gray-900 border border-blue-500/30 rounded-xl p-4 shadow-2xl shadow-blue-500/20 flex items-center justify-between gap-4 backdrop-blur-md">
