  ...
  return (
    ...
    >
      <div className="relative w-full max-w-lg px-6">
        <svg viewBox="0 0 280 60" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-full h-auto">
          <defs>
        ...
        <motion.div
          ...
          className="absolute -bottom-8 left-0 right-0 h-0.5 bg-gradient-to-r from-blue-600 to-cyan-500 origin-left rounded-full mx-6"
        />
      </div>
    </motion.div>
  );
